...
3. 设置密钥以便 commitmate 可以使用它：

   ```sh
   ai config set OPENAI_KEY=<your token>
   ```

   这将在您的主目录中创建一个名为 `.commitmate` 的文件。
...
如果它不是[最新版本](https://github.com/khulnasoft/commitmate/tags)，请运行：
...
如果您想在 [Issues](https://github.com/khulnasoft/commitmate/issues) 中修复错误或实现功能（提示：注意 `help wanted` 标签），请查看 [Contribution Guide](CONTRIBUTING.md) 以了解如何设置项目。
...
欢迎加入 [KhulnaSoft Discord](https://discord.gg/EMx6e58xnw) 并在 #commitmate 房间与我们聊天。
...
<p align="center">
   <a href="https://www.builder.io/m/developers">
      <picture>
         ...
         <img width="250" alt="Made with love by KhulnaSoft" src="https://user-images.githubusercontent.com/844291/230786555-a58479e4-75f3-4222-a6eb-74c5af953eac.png">
       </picture>
   </a>
</p>
